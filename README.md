...
y.index = pd.DatetimeIndex(start='1981-01-01',end='1990-12-31',freq='d')
test,valid = y[365:365*3],y[365*3:365*6],
test.index,valid.index = y.index[365:365*3],y.index[365*3:365*6]
```

# Build Model 
Set up the model parameters
  * (p,d,q): order of the AR parameters, differences, and MA parameters.
  * (P,D,Q,s): seasonal component order of the AR parameters, differences, and MA parameters.
```python
import itertools
p = d = q = range(0, 2)
...
aic_min = float("inf") #  use AIC (Akaike Information Criterion) to evalute the performance of each model.
param = (0,0,0,0,0,0)
